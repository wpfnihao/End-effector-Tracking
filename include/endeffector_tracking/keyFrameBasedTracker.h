/**
 * @file keyFrameBasedTracker.h
 * @brief this the header file of the keyFrameBasedTracker class
...
class keyFrameBasedTracker: public vpMbEdgeKltTracker
{
	...
	public:
		...
		/**
		 * @brief the dataset for key frame
		 */
...
//					float& 			Z);
		 ...
		 */
		void optimizePose(cv::Mat& img, dataset_t& prePatch, keyFrameDataset_t& dataPatches, std::vector<int> patchID);
		...
		void findClosestPatch(vpHomogeneousMatrix& cMo, keyFrameDataset_t& keyFrames, int numPatches, std::vector<int>& id);
		 ...
		 * @return 				residuals
		 */
		double getPose(const vpImage<unsigned char>& I, cv::Mat& img, dataset_t& prePatch, keyFrameDataset_t& dataPatches, std::vector<int> patchID);
		 ...
		 * @param dataPatches 	patches in the dataset
		 */
		void trackPatch(vpPoseFeatures& featuresComputePose, cv::Mat& img, dataset_t& prePatch, keyFrameDataset_t& dataPatches, std::vector<int> patchID);
